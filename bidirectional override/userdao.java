...
public class UserDao 
{
  ...
  public static void InsertUser(int UserId,String UserName,String DateOfBirth,String Address,String email,long Contact,int AadharId)
  {
  	user user = new user();
...
System.out.println("Invalid user id");
 ...
 public static void updateuser(int userid)
 {
	 ...
	 {
		 transaction.begin();
		 user.setEmail("ronaldojuv@gmail.com");
		 Adharcard card = user.getAdhar();
		 card.setDob("4-feb-1980");
		 transaction.commit();
	 }
